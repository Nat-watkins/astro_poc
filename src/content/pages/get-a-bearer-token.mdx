...
Bearer tokens, also known as access tokens or JSON web tokens, authorize use of the Blue Button 2.0 (BCDA) endpoints. You will need a bearer token to [access claims data](/access-claims-data.html) in the sandbox and production environments.
